...
<body>
<!--datagrid栏-->
<table id="OPListForSpecimen" title="日期查询" class="easyui-datagrid" style="width: auto; height: 500px;text-align:center"
...
<thead>
    <tr>
        ...
        <th field="PatientId" width="8%" id="PatientId" sortable="true">病人唯一标识号</th>
        <th field="InpNO" width="5%" id="InpNO" sortable="true">住院号</th>
        <th field="VisitId" width="8%" id="VisitId" sortable="true">就诊号</th>
        <th field="Name" width="6%"  id="Name" sortable="true">姓名</th>
        <th field="DateOfAge" width="3%" id="DateOfAge">年龄</th>
        <th field="DeptCodeName" width="8%" id="DeptCodeName" sortable="true" >科室名称</th>
        <th field="OperatingName" width="12%" id ="OperatingName">手术名称</th>
        <th field="DiagBeforeOperation"width="10%"  id="DiagBeforeOperation" sortable="true">主要诊断</th>
        <th field="KeepSpecimenSign" width="4%" id="KeepSpecimenSign" sortable="true">留样</th>
        <th field="LabInfo" width="5%" id="LabInfo" sortable="true">阳性结果</th>
        <th field="Sex" width="4%" id="Sex" >性别</th>
        <!--20160712 添加字段-->
        <th field="OrdDesc" width="12%" id="OrdDesc" >医嘱名称</th>
        <th field="OrdSt" width="10%" id="OrdSt" >医嘱日期</th>
        <th field="Beizhu" width="4%" id="Beizhu" >备注</th>
        <!--20160712 End-->
        
        <th field="id" hidden="true" >id</th>
        <th field="ScheduleId" hidden="true">手术id号</th>
        <th field="BirthPlace"  hidden="true">行政区名称</th>
        <th field="Citizenship" hidden="true">国家简称</th>
        <th field="Nation"      hidden="true">民族</th>
        <th field="IDNO"        hidden="true" >身份证号</th>
        <th field="Identity"    hidden="true">患者工作身份</th>
        <th field="ChargeType"  hidden="true">病人收费类别</th>
        <th field="MailingAddress"      hidden="true">永久通信地址</th>
        <th field="ZipCode"             hidden="true">邮政编码</th>
        <th field="PhoneNumberHome"     hidden="true">家庭电话号码</th>
        <th field="PhoneNumbeBusiness"  hidden="true">单位电话号码</th>
        <th field="NextOfKin"           hidden="true">亲属姓名</th>
        <th field="RelationShip"        hidden="true">亲属关系</th>
        <th field="NextOfKinAddr"       hidden="true">联系人地址</th>
        <th field="NextOfKinZipCode"    hidden="true">联系人邮政编码</th>
        <th field="NextOfKinPhome"      hidden="true">联系人电话号码</th>
        <th field="DeptCode"            hidden="true">科室代码@名称</th>
        <th field="BedNO"               hidden="true">病人所住床号</th>
        <th field="AdmissionDateTime"   hidden="true">入院日期及时间</th>
        <th field="DoctorInCharge"width="100" hidden="true">主治医生工号@姓名</th>
        <th field="ScheduledDateTime"   hidden="true">预约进行该次手术的日期及时间</th>
        <th field="OperatingRoom"       hidden="true">手术室代码@名称</th>
        <th field="Surgeon"             hidden="true">手术医师工号@姓名</th>
        <th field="InPatPreillness"  hidden="true">现病史</th>
        <th field="InPatPastillness" hidden="true">既往史</th>
        <th field="InPatFamillness"  hidden="true">家族史</th>
        <th field="NamePhonetic"  hidden="true">姓名拼音</th>
        <th field="DateOfBirth"  hidden="true">出生日期</th>
    </tr>
</thead>
</table>
